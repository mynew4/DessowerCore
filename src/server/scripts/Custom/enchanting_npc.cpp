...
class enchantmentAI : public ScriptedAI
	{
	public:
		enchantmentAI(Creature* creature) : ScriptedAI(creature) {}
	...
	void ShowMainMenu(Player* player, Creature* creature)
	{
		...
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Inv_mace_116:35:35|t[Зачаровать Оружие]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Inv_axe_113:35:35|t[Зачаровать Двуручное Оружие]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Inv_weapon_crossbow_38:35:35|t[Зачаровать Оружие Дальнего Боя]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 13);
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Inv_shield_71:35:35|t[Зчаровать Щит]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Inv_helmet_151:35:35|t[Зчаровать Шлем]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Inv_shoulder_130:35:35|t[Зачаровать Плечи]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Inv_misc_cape_18:35:35|t[Зачаровать Плащ]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Inv_chest_plate_26:35:35|t[Зачаровать нагрудник]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Inv_bracer_43:35:35|t[Зачаровать Браслет]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Inv_gauntlets_87:35:35|t[Зачаровать Перчатки]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Inv_belt_52:35:35|t[Eternal Belt Buckle]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Inv_pants_plate_31:35:35|t[Зачаровать Ноги]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Inv_boots_plate_13:35:35|t[Зачаровать Боты]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 12);
		if (player->HasSkill(SKILL_ENCHANTING) && player->GetSkillValue(SKILL_ENCHANTING) >= 450)
		{
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|TInterface/ICONS/Inv_jewelry_ring_85:35:35|t[Зачаровать Кольцо]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 14);
		}
	...
	{
		return  new enchantmentAI(creature);
	}
